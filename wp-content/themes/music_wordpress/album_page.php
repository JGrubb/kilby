			...
			<li class="album_info">
				...
				<ul class="album_songs">
					<?php $b = 0; while($b <= $music_limit) : ?>
						<li class="<?php echo $odd_even; ?>"><a class="wpaudio-nodl" href="<?php bloginfo('template_directory'); ?>/music/<?php echo $music_list_array[$b] . '.mp3'; ?>"><?php echo $music_list_array[$b]; ?></a></li>
